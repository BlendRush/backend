...
const sendResetEmail = async (to, resetToken) => {
  ...
  const mailOptions = {
    ...
    to,
    subject: "Reset Your Password – blendRUSH",
    html: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; padding: 20px;">
        <h2 style="color: #4CAF50;">blendRUSH Password Reset</h2>
        <p>Hi there,</p>
        <p>You recently requested to reset your blendRUSH account password.</p>
